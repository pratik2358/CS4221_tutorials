...
\begin{frame}{The TA Team welcomes you to CS4221/5421}
    \begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{tut_01_files/ERD.pdf}
    % \caption{Caption}
    % \label{fig:placeholder}
\end{figure}
\end{frame}

\begin{frame}{Telegram Group}
\begin{figure}
    \centering
    \includegraphics[width=1\linewidth]{tut_01_files/ERD_tg.pdf}
    % \caption{Caption}
    % \label{fig:placeholder}
\end{figure}
\end{frame}
