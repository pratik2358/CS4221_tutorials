...
\title{CS4221/5421: Tutorial 6 — Functional Dependencies}
...
\pause
Show that $\Sigma \vdash \{C,D\} \to \{A,B,C,D,E\}$ using Armstrong's axioms.
\begin{columns}
    \column{0.3\textwidth}
        \begin{enumerate}
            \item $\{C,D\} \to \{A,B\}$
...
\centering
    ...
    \href{https://github.com/pratik2358/fucntional_dep}{\textcolor{blue}{https://github.com/pratik2358/fucntional\_dep}}
\end{frame}
